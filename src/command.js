...
"           #️ Ketik Cyduk Untuk Melihat Sider! ️#");
    ...
    keluar() {
       {            this._sendMessage(this.messages, `Lo Mau Ngusir Gua Bro???`);
      }
      {
    ...
    batal() {
                   this._sendMessage(this.messages, `Oke Bro Kita Gajadi Baku Hantam`);
      }
...
admin1() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'u99f8059e2924cfa7519e26691b3cbb78'}
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
...
admin3() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'ufedfd6819d63f9235007cab688acebe7' }
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
...
admin4() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'ub1594fa0d3959eb82ac73675541d7ee0' }
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }

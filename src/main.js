...
const myBott = ['u1d55aeaa8b863cb338f4e8fd7a761b4b','u99f8059e2924cfa7519e26691b3cbb78','ufedfd6819d63f9235007cab688acebe7','ub1594fa0d3959eb82ac73675541d7ee0'];//TARO MID LU DISINI SUPAYA BISA PKE COMMAND STAFF

const myBot = ['u1d55aeaa8b863cb338f4e8fd7a761b4b','u99f8059e2924cfa7519e26691b3cbb78','ufedfd6819d63f9235007cab688acebe7','ub1594fa0d3959eb82ac73675541d7ee0'];//TARO MID LU DISINI
...
//        if(operation.type == 26) { 		
	    ...
	    this.textMessage("0103",seq,operation.param2,1);
          ...
          if(operation.type == 15 && this.stateStatus.sambutan == 1) {
             ...
             out.text = "Semoga Tenang Kawand, #outinpeace"
            ...
            if(operation.type == 17 && this.stateStatus.sambutan == 1) {
               ...
               kam.text = "Welcome, Ingat Ya Young Itu Tampan"
           ...
           if(operation.type == 16 && this.stateStatus.sambutan == 1) {
             ...
             itil.text = "Kok Gua Gak Di Welcomein Bgst"
           ...
           if(operation.type == 19 && this.stateStatus.sambutan == 1) {
             ...
             plerrr.text = "Gosah Maen Kick Kampang"
           ...
           if(seq.contentType == 13 && this.sendStaff == 2)
{
    ...
    await this._sendMessage(seq,'Sukses Menghapus Staff~');
        ...
        {
         this._sendMessage(seq, 'Hallo Juga Bgst');
         }
     }
        ...
        if(txt == 'speed') {
            ...
            await this._sendMessage(seq,'Sabar bro lagi loading');
...
let { listMember } = await this.searchGroup(seq.to);
     const mentions = await this.mention(listMember);
        ...
        if(txt == 'creator') {
           this._sendMessage(seq, 'Mana Saya Tau Saya Kan Gatau');
           seq.contentType=13;
           seq.contentMetadata = { mid: 'u1d55aeaa8b863cb338f4e8fd7a761b4b' };
           this._client.sendMessage(1, seq);
        }
        ...
        if(cmd == 'spam') {
            for(var i= 0; i < 20;  i++) {
               this._sendMessage(seq, 'Saya Itu Tampan');
        }
    }
        ...
        if(txt == 'bye') {
           if(!isAdminOrBot(seq.from) || !isStaffOrBot(seq.from)){
          let txt = await this._sendMessage(seq, 'Gak Usah Ngusir Bro, Saya Bisa Out Sendiri Kok');
